...
* steepcoin.conf: contains configuration settings for steepcoind or steepcoin-qt
* steepcoind.pid: stores the process id of steepcoind while running
...
* debug.log: contains debug information and general logging generated by steepcoind or steepcoin-qt
