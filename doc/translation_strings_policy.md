...
This document provides guidelines for internationalization of the Steepcoin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `steepcoin_en.ts` remains unchanged.
