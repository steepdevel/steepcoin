...
#ifndef STEEPCOIN_POLICY_POLICY_H
#define STEEPCOIN_POLICY_POLICY_H
...
//steepTODO until fork we can't enforce this                   SCRIPT_VERIFY_LOW_S |
...
#endif // STEEPCOIN_POLICY_POLICY_H
