...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s steepcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  steepcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded steepcoin transaction") + "\n" +
              "  steepcoin-tx [options] -create [commands]   " + _("Create hex-encoded steepcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded steepcoin transaction
