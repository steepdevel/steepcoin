...
#ifndef STEEPCOIN_CHAIN_H
#define STEEPCOIN_CHAIN_H
...
// steepcoin
    // steepcoin: money supply related block index fields
    int64_t nMint;
    int64_t nMoneySupply;

    // steepcoin: proof-of-stake related block index fields
    unsigned int nFlags;  // steepcoin: block index flags
    enum
    {
...
// steepcoin end
    ...
    /**
     * Duplicate from steepcoinrpc that originaly define this method.
