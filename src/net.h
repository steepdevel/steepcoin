...
#ifndef STEEPCOIN_NET_H
#define STEEPCOIN_NET_H
...
/** steepcoin: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // steepcoin: known sent sync-checkpoint
    ...
    // steepcoin: used to detect branch switches
