...
#ifndef STEEPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define STEEPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // STEEPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
