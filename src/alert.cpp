...
// Copyright (c) 2009-2015 The SteepCoin Core developers
...
{
    return AppliesTo(PROTOCOL_VERSION, FormatSubVersion(CLIENT_NAME, STEEPCOIN_VERSION, std::vector<std::string>()));
}
