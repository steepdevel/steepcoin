...
#ifndef STEEPCOIN_SCRIPT_STEEPCOINCONSENSUS_H
#define STEEPCOIN_SCRIPT_STEEPCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_STEEPCOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/steepcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBSTEEPCOINCONSENSUS)
...
#define STEEPCOINCONSENSUS_API_VER 1
...
#endif // STEEPCOIN_SCRIPT_STEEPCOINCONSENSUS_H
