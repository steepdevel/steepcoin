...
{
    BOOST_CHECK(TestSplitHost("www.steepcoin.org", "www.steepcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.steepcoin.org]", "www.steepcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.steepcoin.org:80", "www.steepcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.steepcoin.org]:80", "www.steepcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:36468", "127.0.0.1", 36468));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:36468", "127.0.0.1", 36468));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:36468", "::ffff:127.0.0.1", 36468));
    BOOST_CHECK(TestSplitHost("[::]:36468", "::", 36468));
    BOOST_CHECK(TestSplitHost("::36468", "::36468", -1));
    BOOST_CHECK(TestSplitHost(":36468", "", 36468));
    BOOST_CHECK(TestSplitHost("[]:36468", "", 36468));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:36468", "127.0.0.1:36468"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:36468", "[::]:36468"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
