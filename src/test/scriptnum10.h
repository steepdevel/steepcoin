...
#ifndef STEEPCOIN_TEST_SCRIPTNUM10_H
#define STEEPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SteepCoin Core 0.10.0, for cross-comparison.
 */
public:
