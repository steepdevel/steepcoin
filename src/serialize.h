...
#ifndef STEEPCOIN_SERIALIZE_H
#define STEEPCOIN_SERIALIZE_H
...
enum
{
    ...
    SER_POSMARKER       = (1 << 18),  // steepcoin: for sending block headers with PoS marker, to allow headers-first syncronization
};
