...
#error Client version information missing: version is not defined by steepcoin-config.h or in any other way
#endif

#if !defined(STEEPCOIN_VERSION_MAJOR) || !defined(STEEPCOIN_VERSION_MINOR) || !defined(STEEPCOIN_VERSION_REVISION) || !defined(STEEPCOIN_VERSION_BUILD)
#error Client version information missing: version is not defined by steepcoin-config.h or in any other way
#endif
...
static const int STEEPCOIN_VERSION =
                         ...
                         +     100 * STEEPCOIN_VERSION_REVISION
                         +       1 * STEEPCOIN_VERSION_BUILD;
...
std::string FormatSubVersion(const int nClientVersion, const std::vector<std::string>& comments);
