...
#ifndef STEEPCOIN_CHECKPOINTSYNC_H
#define STEEPCOIN_CHECKPOINTSYNC_H
...
// Synchronized checkpoint (introduced first in steepoin)
...
#endif // STEEPCOIN_CHECKPOINTSYNC_H
