// Copyright (c) 2017-2017 The SteepCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef STEEPCOIN_CONSENSUS_TX_VERIFY_H
#define STEEPCOIN_CONSENSUS_TX_VERIFY_H
...
// steepcoin: minimum fee for transaction to be accepted in a blockchain.
CAmount GetMinFee(const CTransaction& tx);
CAmount GetMinFee(size_t nBytes, uint32_t nTime);

#endif // STEEPCOIN_CONSENSUS_TX_VERIFY_H
