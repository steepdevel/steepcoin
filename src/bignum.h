...
// Copyright (c) 2009-2012 The SteepCoin developers
// Copyright (c) 2017-2021 The Steepcoin developers
// Copyright (c) 2018-2018 The Emercoin developers
#ifndef STEEPCOIN_BIGNUM_H
#define STEEPCOIN_BIGNUM_H
...
public:
    ...
    //
    // SteepCoin only uses this "compact" format for encoding difficulty
