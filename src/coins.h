...
#ifndef STEEPCOIN_COINS_H
#define STEEPCOIN_COINS_H
...
public:
    ...
    // steepcoin: whether transaction is a coinstake
    bool fCoinStake;

    // steepcoin: transaction timestamp
    unsigned int nTime;
    ...
    bool IsCoinStake() const { // steepcoin: coinstake
        return fCoinStake;
    }
...
public:
    ...
    /** 
     * Amount of steepcoins coming in to a transaction
