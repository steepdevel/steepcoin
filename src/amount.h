...
// Copyright (c) 2009-2016 The SteepCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef STEEPCOIN_AMOUNT_H
#define STEEPCOIN_AMOUNT_H
 ...
 *
 * Note that this constant is *not* the total money supply, which in SteepCoin
 * currently happens to be less than 21,000,000 STEEP for various reasons, but
