...
#ifndef STEEPCOIN_WALLET_WALLET_H
#define STEEPCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this steepcoin node, and set to 0 for transactions that were created
...
#endif // STEEPCOIN_WALLET_WALLET_H
