...
// steepcoin: optional setting to unlock wallet for block minting only;
...
//    return n ? n : nTimeReceived;
    ...
    // steepcoin: we still have the timestamp, so use it to avoid confusion
    return tx->nTime;
}
...
// steepcoin: total coins staked (non-spendable until maturity)
...

    {
        ...
        for (const auto& entry : mapWallet)
        {
            ...
            if (nSpendTime > 0 && pcoin->tx->nTime > nSpendTime)
                continue;  // steepcoin: timestamp must not exceed spend time
...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/steepcoin/steepcoin/pull/10340, but that change has been
    // postponed until after https://github.com/steepcoin/steepcoin/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    txNew.nTime = wtxNew.tx->nTime;  // steepcoin: set time
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-steepcoin-address
...
//steepTODO: this code was in 0.7:
...
//                }
                ...
                // steepcoin: sub-cent change is moved to fee
...
//steepTODO: this code was in 0.7, but was refactored by b33d1f5ee512da5719b793b3867f75f1eea5cf52:
//                int64 nPayFee;
//                if (fNewFees)
...
//                    nPayFee = nTransactionFee * (1 + (int64)nBytes / 1000);
                ...
                if (nFeeRet >= nFeeNeeded) {
                    ...
                    if (nChangePosInOut == -1 && nSubtractFeeFromAmount == 0 && pick_new_inputs) {
                        ...
                        CAmount minimum_value_for_change = MIN_TXOUT_AMOUNT;  //steepTODO - is this correct?
 ...
 * https://steepcointalk.org/?topic=54527, or
 * https://github.com/steepcoin/steepcoin/pull/1393.
 */
...
// steepcoin: create coin stake transaction
