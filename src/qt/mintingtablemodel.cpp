    ...
    {
        {
            ...
            {
                return TransactionDesc::toHTML(wallet, mi->second, nullptr, SteepCoinUnits::STEEP);  //steepTODO - fix the last 2 parameters
            }
        }
        return QString("");
    }
...
{
    return SteepCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->nValue);
}
