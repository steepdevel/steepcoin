...
#ifndef STEEPCOIN_QT_STEEPCOINUNITS_H
#define STEEPCOIN_QT_STEEPCOINUNITS_H
...
/** SteepCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SteepCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SteepCoinUnits(QObject *parent);

    /** SteepCoin units.
      @note Source: https://en.steepcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STEEP,
...
typedef SteepCoinUnits::Unit SteepCoinUnit;

#endif // STEEPCOIN_QT_STEEPCOINUNITS_H
