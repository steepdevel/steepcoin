...
# TestNode: A peer we use to send messages to steepcoind, and store responses.
...
class CompactBlocksTest(SteepCoinTestFramework):
    ...
    # This test actually causes steepcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that steepcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for steepcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # steepcoind will not send blocktxn responses for blocks whose height is
