...
By default, steepcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SteepCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give steepcoind a second to reload the mempool
        ...
        self.log.debug("Prevent steepcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
